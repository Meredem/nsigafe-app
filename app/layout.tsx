        ...
        <header className="bg-gradient-to-b from-green-700 via-green-600 to-green-500 text-white shadow-2xl sticky top-0 z-50">
          <div className="container mx-auto px-4 py-12">
            ...
            <div className="flex flex-col items-center text-center mb-8">
              <img src="/foot1.jpg" alt="Logo Centre Sportif Bouba & Mane" className="h-48 w-48 object-cover rounded-full shadow-2xl border-6 border-yellow-400 hover:scale-105 transition-transform duration-300 mb-6" />
