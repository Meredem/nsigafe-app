        ...
        <div className="mb-20 bg-gradient-to-r from-red-50 to-yellow-50 p-8 rounded-3xl border-4 border-red-400">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-8">
            <div className="group rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300">
              <img src="/photo1.jpg" alt="Match - Photo nouvelle" className="w-full h-screen object-cover group-hover:scale-110 transition-transform duration-300" loading="eager" />
              <div className="p-4 bg-white">
                <p className="text-center font-semibold text-gray-700">Match - Photo nouvelle</p>
              </div>
            </div>
            <div className="group rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300">
              <img src="/photo2.jpg" alt="Équipe - Photo nouvelle" className="w-full h-screen object-cover group-hover:scale-110 transition-transform duration-300" loading="eager" />
              <div className="p-4 bg-white">
                <p className="text-center font-semibold text-gray-700">Équipe - Photo nouvelle</p>
              </div>
            </div>
            <div className="group rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300">
              <img src="/photo3.jpg" alt="Entraînement - Photo nouvelle" className="w-full h-screen object-cover group-hover:scale-110 transition-transform duration-300" loading="eager" />
              <div className="p-4 bg-white">
                <p className="text-center font-semibold text-gray-700">Entraînement - Photo nouvelle</p>
              </div>
            </div>
            <div className="group rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300">
              <img src="/photo4.jpg" alt="Moment fort - Photo nouvelle" className="w-full h-screen object-cover group-hover:scale-110 transition-transform duration-300" loading="eager" />
              <div className="p-4 bg-white">
